...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String items[] = {"Ambil Gambar dari Kamera","Pilih Gambar dari Gallery","Batalkan"};
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if(items[i].equals("Ambil Gambar dari Kamera")){checkPermC();}
                        else if(items[i].equals("Pilih Gambar dari Gallery")){galleryIntent();}
    ...
    private void showAlert(){
        ...
        alertDialog.setMessage("Aplikasi ini butuh mengakses kamera!");
        alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "JANGAN", new DialogInterface.OnClickListener() {
            @Override
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "IJINKAN", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
    ...
    private void showAlertG(){
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(MainActivity.this,R.style.Theme_AppCompat_Dialog_Alert).create();
        alertDialog.setTitle("Alert");
        alertDialog.setMessage("Aplikasi ini butuh mengakses Storage!");
        alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "JANGAN", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int which) {
                dialogInterface.dismiss();
